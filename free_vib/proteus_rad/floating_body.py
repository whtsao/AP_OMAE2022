...
# TANK
tank = st.Tank2D(domain, dim=(10., 4.)) #(2*wavelength, 2*water_level)) #---tsao mod---#

# SPONGE LAYERS
# generation zone: 1 wavelength
# absorption zone: 2 wavelengths
tank.setSponge(x_n=4., x_p=4.)
...
#caisson.rotate(rot=0.261799388) # 15 degree
#caisson.rotate(rot=0.1745329252) # 10 degree
caisson.rotate(rot=0.0872664626) # 5 degree

caisson.translate(np.array([5., water_level])) #---tsao mod---#
...
#smoothing = he*1.5
dragAlpha = 1.e+6 #5*2*np.pi/wave_period/(1.004e-6)
